...
const prizeDetails = [
  ...
  },
  {
    ...
    lines: [
      ...
      [{ text: "Cơ hội " }, { text: "thực tập thực tế", bold: true }, { text: " tại XNOQuant, NTQ Solution, Eztech, và Techcamp." }],
      [{ text: "Cơ hội " }, { text: "phỏng vấn trực tiếp", bold: true }, { text: " với chuyên gia Data Analyst và được " }, { text: "giới thiệu CV", bold: true }, { text: " tới các công ty đối tác của " }, { text: "Techcamp", bold: true }, { text: "." }],
      [{ text: "04 Suất học bổng đồng hành với tổng trị giá lên đến " }, { text: "110.000.000 VNĐ", bold: true }, { text: " tài trợ bởi " }, { text: "Edu2Review", bold: true }, { text: "." }],
      [{ text: "04 suất học bổng " }, { text: "80%", bold: true }, { text: " cho các khóa combo chuyên sâu (Power BI) tại " }, { text: "MCNA", bold: true }, { text: "." }],
      [{ text: "04 suất học bổng " }, { text: "70%", bold: true }, { text: " cho các khóa học đơn (DA, BI, AI) tại " }, { text: "MCNA", bold: true }, { text: "." }],
      [
        { text: "04 Suất học bổng bao gồm: Voucher ưu đãi " },
        { text: "50%", bold: true },
        { text: " học phí cho cả 2 khóa học thực hành " },
        { text: "Business Analyst", bold: true },
        { text: " và " },
      ...
      [{ text: "04 Voucher ưu đãi " }, { text: "30% khóa học", bold: true }, { text: " đến từ đơn vị đào tạo " }, { text: "86HSK", bold: true }, { text: "." }],
      [{ text: "04 Voucher học tập trị giá " }, { text: "1.000.000 VNĐ/voucher", bold: true }, { text: " đến từ đơn vị " }, { text: "The English Tutor", bold: true }, { text: "." }],
    ],
