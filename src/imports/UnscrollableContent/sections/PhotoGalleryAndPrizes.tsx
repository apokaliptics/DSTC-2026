...
const prizeDetails = [
  {
    ...
    titleAlt: "Quán quân",
    lines: [
      [{ text: "Hiện kim ", bold: true }, { text: "7.000.000 VNĐ." }],
      [{ text: "Cơ hội " }, { text: "thực tập thực tế", bold: true }, { text: " tại XNOQuant, NTQ Solution, Eztech, và Techcamp." }],
      [{ text: "Cơ hội " }, { text: "phỏng vấn trực tiếp", bold: true }, { text: " với chuyên gia Data Analyst và được " }, { text: "giới thiệu CV", bold: true }, { text: " tới các công ty đối tác của " }, { text: "Techcamp", bold: true }, { text: "." }],
      [{ text: "02 Học bổng toàn phần với tổng trị giá lên đến " }, { text: "189.000.000 VNĐ", bold: true }, { text: " tài trợ bởi " }, { text: "Edu2Review", bold: true }, { text: "." }],
      [{ text: "02 suất học bổng " }, { text: "80%", bold: true }, { text: " cho các khóa combo chuyên sâu (Power BI) tại " }, { text: "MCNA", bold: true }, { text: "." }],
      [{ text: "02 suất học bổng " }, { text: "70%", bold: true }, { text: " cho các khóa học đơn (DA, BI, AI) tại " }, { text: "MCNA", bold: true }, { text: "." }],
      [
      ...
      [{ text: "02 Voucher ưu đãi " }, { text: "30% khóa học", bold: true }, { text: " đến từ đơn vị đào tạo " }, { text: "86HSK", bold: true }, { text: "." }],
      [{ text: "02 Voucher học tập trị giá " }, { text: "3.000.000 VNĐ/voucher", bold: true }, { text: " đến từ đơn vị " }, { text: "The English Tutor", bold: true }, { text: "." }],
    ],
    className: "top-0",
  },
  {
    ...
    titleAlt: "Á quân",
    lines: [
      [{ text: "Hiện kim ", bold: true }, { text: "4.000.000 VNĐ." }],
      [{ text: "Cơ hội " }, { text: "thực tập thực tế", bold: true }, { text: " tại XNOQuant, NTQ Solution, Eztech, và Techcamp." }],
      [{ text: "Cơ hội " }, { text: "phỏng vấn trực tiếp", bold: true }, { text: " với chuyên gia Data Analyst và được " }, { text: "giới thiệu CV", bold: true }, { text: " tới các công ty đối tác của " }, { text: "Techcamp", bold: true }, { text: "." }],
      [{ text: "02 Học bổng toàn phần với tổng trị giá lên đến " }, { text: "189.000.000 VNĐ", bold: true }, { text: " tài trợ bởi " }, { text: "Edu2Review", bold: true }, { text: "." }],
      [{ text: "02 suất học bổng " }, { text: "80%", bold: true }, { text: " cho các khóa combo chuyên sâu (Power BI) tại " }, { text: "MCNA", bold: true }, { text: "." }],
      ...
      [{ text: "02 Voucher ưu đãi " }, { text: "30% khóa học", bold: true }, { text: " đến từ đơn vị đào tạo " }, { text: "86HSK", bold: true }, { text: "." }],
      [{ text: "02 Voucher học tập trị giá " }, { text: "2.000.000 VNĐ/voucher", bold: true }, { text: " đến từ đơn vị " }, { text: "The English Tutor", bold: true }, { text: "." }],
    ],
  ...
  },
  {
    ...
    titleAlt: "Quý quân",
    lines: [
      [{ text: "Hiện kim ", bold: true }, { text: "2.000.000 VNĐ." }],
      [{ text: "Cơ hội " }, { text: "thực tập thực tế", bold: true }, { text: " tại XNOQuant, NTQ Solution, Eztech, và Techcamp." }],
      [{ text: "Cơ hội " }, { text: "phỏng vấn trực tiếp", bold: true }, { text: " với chuyên gia Data Analyst và được " }, { text: "giới thiệu CV", bold: true }, { text: " tới các công ty đối tác của " }, { text: "Techcamp", bold: true }, { text: "." }],
      [{ text: "02 Suất học bổng đồng hành với tổng trị giá lên đến " }, { text: "110.000.000 VNĐ", bold: true }, { text: " tài trợ bởi " }, { text: "Edu2Review", bold: true }, { text: "." }],
      [{ text: "02 suất học bổng " }, { text: "80%", bold: true }, { text: " cho các khóa combo chuyên sâu (Power BI) tại " }, { text: "MCNA", bold: true }, { text: "." }],
      [{ text: "02 suất học bổng " }, { text: "70%", bold: true }, { text: " cho các khóa học đơn (DA, BI, AI) tại " }, { text: "MCNA", bold: true }, { text: "." }],
      [
        { text: "02 Suất học bổng bao gồm: Voucher ưu đãi " },
      ...
      [{ text: "02 Voucher ưu đãi " }, { text: "30% khóa học", bold: true }, { text: " đến từ đơn vị đào tạo " }, { text: "86HSK", bold: true }, { text: "." }],
      [{ text: "02 Voucher học tập trị giá " }, { text: "1.000.000 VNĐ/voucher", bold: true }, { text: " đến từ đơn vị " }, { text: "The English Tutor", bold: true }, { text: "." }],
    ],
...
function Group1() { return (<div className="absolute contents inset-[74.61%_31.61%_23.55%_34.2%]" data-name="Group"><div className="absolute inset-[74.61%_31.61%_23.55%_34.2%] mask-intersect mask-luminance mask-no-clip mask-no-repeat mask-position-[-0.001px_2.861px] mask-size-[656.473px_307.622px]" style={{ maskImage: `url('${imgRectangle}')`, WebkitMaskImage: `url('${imgRectangle}')` }} data-name="Rectangle"><div className="absolute inset-0 overflow-hidden pointer-events-none"><img loading="lazy" alt="" className="absolute left-0 max-w-none size-full top-0" src={imgRectangle1} /></div></div></div>); }
...
function Group3() { return (<div className="absolute contents inset-[77.22%_16.52%_21.28%_58.84%]" data-name="Group"><div className="absolute inset-[77.22%_16.52%_21.28%_58.84%] mask-intersect mask-luminance mask-no-clip mask-no-repeat mask-position-[0px_0px] mask-size-[473.167px_251.448px]" style={{ maskImage: `url('${imgRectangle2}')`, WebkitMaskImage: `url('${imgRectangle2}')` }} data-name="Rectangle"><div className="absolute inset-0 overflow-hidden pointer-events-none"><img loading="lazy" alt="" className="absolute left-0 max-w-none size-full top-0" src={imgRectangle3} /></div></div></div>); }
...
function Group6() { return (<div className="absolute contents inset-[77.23%_60.33%_21.22%_16.89%]" data-name="Group"><div className="absolute inset-[77.23%_60.33%_21.22%_16.89%] mask-position-[0.945px_-0.456px,_0px_0px]" style={{ maskImage: `url('${imgRectangle4}'), url('${imgRectangle5}')`, WebkitMaskImage: `url('${imgRectangle4}'), url('${imgRectangle5}')` }} data-name="Rectangle"><div className="absolute inset-0 overflow-hidden pointer-events-none"><img loading="lazy" alt="" className="absolute left-0 max-w-none size-full top-0" src={imgRectangle6} /></div></div></div>); }
...
function Group10() { return (<div className="absolute contents inset-[25.47%_36.89%_16.62%_30.29%]" data-name="Group"><div className="absolute inset-[25.47%_36.89%_16.62%_30.29%] mask-position-[-7.161px_-37.578px,_5.079px_-1.802px,_0px_0px]" style={{ maskImage: `url('${imgRectangle7}'), url('${imgRectangle8}'), url('${imgRectangle9}')`, WebkitMaskImage: `url('${imgRectangle7}'), url('${imgRectangle8}'), url('${imgRectangle9}')` }} data-name="Rectangle"><div className="absolute inset-0 overflow-hidden pointer-events-none"><img loading="lazy" alt="" className="absolute left-0 max-w-none size-full top-0" src={imgRectangle10} /></div></div></div>); }
...
function Group12() { return (<div className="absolute contents inset-[45.54%_42.89%_37.03%_36.1%]" data-name="Group"><div className="absolute inset-[45.54%_42.89%_37.03%_36.1%] mask-position-[-168.544px_-353.385px,_-0.001px_0px]" style={{ maskImage: `url('${imgRectangle7}'), url('${imgRectangle11}')`, WebkitMaskImage: `url('${imgRectangle7}'), url('${imgRectangle11}')` }} data-name="Rectangle"><div className="absolute inset-0 overflow-hidden pointer-events-none"><img loading="lazy" alt="" className="absolute left-0 max-w-none size-full top-0" src={imgRectangle1} /></div></div></div>); }
...
function Group19() { return (<div className="absolute contents inset-[43.77%_22.53%_5.98%_49.2%]" data-name="Group"><div className="absolute inset-[43.77%_22.53%_5.98%_49.2%] mask-position-[151.624px_-0.428px,_0.642px_-0.001px,_0px_0px]" style={{ maskImage: `url('${imgRectangle12}'), url('${imgRectangle13}'), url('${imgRectangle14}')`, WebkitMaskImage: `url('${imgRectangle12}'), url('${imgRectangle13}'), url('${imgRectangle14}')` }} data-name="Rectangle"><div className="absolute inset-0 overflow-hidden pointer-events-none"><img loading="lazy" alt="" className="absolute left-0 max-w-none size-full top-0" src={imgRectangle10} /></div></div></div>); }
...
function Group26() { return (<div className="absolute contents inset-[44.02%_56.62%_5.98%_14.02%]" data-name="Group"><div className="absolute inset-[44.02%_56.62%_5.98%_14.02%] mask-position-[-1.311px_-0.426px,_0.666px_0px,_0px_0px]" style={{ maskImage: `url('${imgRectangle16}'), url('${imgRectangle17}'), url('${imgRectangle18}')`, WebkitMaskImage: `url('${imgRectangle16}'), url('${imgRectangle17}'), url('${imgRectangle18}')` }} data-name="Rectangle"><div className="absolute inset-0 overflow-hidden pointer-events-none"><img loading="lazy" alt="" className="absolute left-0 max-w-none size-full top-0" src={imgRectangle10} /></div></div></div>); }
