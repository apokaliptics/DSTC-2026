...
import logoGoldNTQ from "@/assets/logos/tier-sponsors/gold.png";
import logoCompanion3 from "@/assets/logos/companions/3.png";
import logoCompanion4 from "@/assets/logos/companions/4.png";
import logoCompanion5 from "@/assets/logos/companions/5.png";
import logoCompanion6 from "@/assets/logos/companions/6.png";
import logoCompanion7 from "@/assets/logos/companions/7.png";
import logoCompanion8 from "@/assets/logos/companions/8.png";
import logoMediaBrandsVN from "@/assets/logos/brands-vn.png";
import logoMediaGiaiTriVanHoa from "@/assets/logos/giai-tri-van-hoa.png";
import logoMediaSongTre from "@/assets/logos/song-tre.jpg";
import logoMediaTapChi from "@/assets/logos/tap-chi-doanh-nghiep.jpg";
import logoMediaYbox from "@/assets/logos/ybox.png";
import logoMediaYouthPlus from "@/assets/logos/youthplus.png";
import logoOrganizerCte from "@/assets/logos/organizers/cte.png";
import logoOrganizerDataScience from "@/assets/logos/organizers/data-science.png";
import logoOrganizerFtu from "@/assets/logos/organizers/ftu.png";
import logoOrganizerYouthUnion from "@/assets/logos/organizers/youth-union.png";
import logoProfessionalEztech from "@/assets/logos/strategic-partners/3.png";
import logoProfessionalFtds from "@/assets/logos/strategic-partners/2.png";
import logoProfessionalMCNA from "@/assets/logos/strategic-partners/5.png";
import logoProfessionalRed from "@/assets/logos/strategic-partners/4.png";
import logoSilverKhangPhuDat from "@/assets/logos/tier-sponsors/silver.png";
import logoStrategicXnoquant from "@/assets/logos/strategic-xnoquant.png";
type LogoItem = {
  src: string;
  alt: string;
  className?: string;
...
export function SponsorsSection() {
  return <motion.section className="absolute left-0 top-[16800px] w-[1920px] flex flex-col items-center z-[10] pb-[220px]" initial={{
    opacity: 0,
    y: 50
  }} whileInView={{
    opacity: 1,
    ...
    ease: "easeOut"
      ...
      {/* Nhà Tài Trợ */}
      {partnerGroups.slice(0, 3).map(group => <div key={group.title} className={`flex flex-col items-center w-full ${group.maxWidth} mb-[120px]`}>
      ...
      <div className="grid grid-cols-2 gap-[130px] items-start w-full max-w-[1400px] mb-[120px]">
        {goldSilverGroups.map(group => <div key={group.title} className={`flex flex-col items-center w-full ${group.maxWidth}`}>
            <h3 className="text-[#cbd5e1] text-[48px] font-['Inter:Extra_Bold',sans-serif] font-extrabold uppercase mb-[55px] tracking-wider text-center">
              {group.title}
            </h3>
      ...
      {partnerGroups.slice(3, -1).map(group => <div key={group.title} className={`flex flex-col items-center w-full ${group.maxWidth} mb-[120px]`}>
          <h3 className="text-[#cbd5e1] text-[48px] font-['Inter:Extra_Bold',sans-serif] font-extrabold uppercase mb-[55px] tracking-wider text-center">
            {group.title}
          </h3>
      ...
      <div className={`flex flex-col items-center w-full ${partnerGroups[partnerGroups.length - 1].maxWidth}`}>
        ...
        <div className={`flex flex-row justify-center items-center ${partnerGroups[partnerGroups.length - 1].gap} flex-wrap`}>
          {partnerGroups[partnerGroups.length - 1].logos.map(logo => <div key={logo.alt} className={logo.tileClassName ?? ""}>
              <img loading="lazy" src={logo.src} alt={logo.alt} className={`${logoClassName} ${logo.className ?? ""}`} />
            </div>)}
        </div>
      </div>
