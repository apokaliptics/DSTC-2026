...
export function FAQSection() {
  return (
    <section id="faq" className="absolute content-stretch flex flex-col gap-[134.714px] h-[1307px] items-start left-[8px] max-w-[1885.9998779296875px] px-[33.679px] top-[14900px] w-[1886px]" data-name="Section - 7. FAQ (Bento Accordions Concept)">
      <Container8 />
