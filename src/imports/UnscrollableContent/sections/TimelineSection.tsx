...
/* Round 1 Body */
function Body2() {
  return <div className="absolute bg-[rgba(255,255,255,0.3)] h-[496.096px] left-[163.59px] rounded-[41.331px] top-[7557.41px] w-[727.954px]" data-name="Body">
      <div aria-hidden="true" className="absolute border-3 border-solid border-white inset-0 pointer-events-none rounded-[41.331px]" />
    </div>;
}
function Round1() {
  return <div className="absolute contents left-[163.59px] top-[7563px]">
...
/* Round 2 Body */
function Body5() {
  return <div className="absolute bg-[rgba(255,255,255,0.3)] h-[492px] left-[1065.02px] rounded-[41.331px] top-[8083.5px] w-[695.04px]" data-name="Body">
      <div aria-hidden="true" className="absolute border-3 border-solid border-white inset-0 pointer-events-none rounded-[41.331px]" />
    </div>;
}
function Round2() {
  return <div className="absolute contents left-[1065px] top-[8091px]">
...
/* Round 3 Body */
function Body4() {
  return <div className="absolute bg-[rgba(255,255,255,0.3)] h-[720px] left-[134.02px] rounded-[41.331px] top-[8591.5px] w-[747.072px]" data-name="Body">
      <div aria-hidden="true" className="absolute border-3 border-solid border-white inset-0 pointer-events-none rounded-[41.331px]" />
    </div>;
}
function Round3() {
  return <div className="absolute contents left-[133.5px] top-[8599px]">
      <Body4 />
...
function Body() {
  return <div className="absolute bg-[rgba(255,255,255,0.5)] h-[181.008px] left-[1065.02px] rounded-[41.331px] top-[8801.55px] w-[663.936px]" data-name="Body"><div aria-hidden="true" className="absolute border-4 border-solid border-white inset-0 pointer-events-none rounded-[41.331px]" /></div>;
}
function Group45() {
  return <div className="absolute contents left-[1065.02px] top-[8801.55px]"><Body /></div>;
}
function Group44() {
  return <div className="absolute contents left-[1065.02px] top-[8801.55px]"><Group45 /></div>;
}
function Group43() {
  return <div className="absolute contents left-[1065.02px] top-[8801.55px]"><Group44 /></div>;
}
function Group42() {
  return <div className="absolute contents left-[1065.02px] top-[8801.55px]"><Group43 /></div>;
}
export function Group41() {
  return <div className="absolute contents left-[1065.02px] top-[8783.92px]"><Group42 /><div className="absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[219.56px] justify-center leading-[0] left-[1123.97px] not-italic text-[33.065px] text-center text-white top-[8783.92px] w-[545.088px]"><p className="leading-[1.5]">Đêm chung kết</p></div></div>;
}
function Body1() {
  return <div className="absolute bg-[rgba(255,255,255,0.5)] h-[182.684px] left-[190.08px] rounded-[41.331px] top-[8224.13px] w-[663.936px]" data-name="Body"><div aria-hidden="true" className="absolute border-4 border-solid border-white inset-0 pointer-events-none rounded-[41.331px]" /></div>;
}
function Group50() {
  return <div className="absolute contents left-[190.08px] top-[8224.13px]"><Body1 /></div>;
}
function Group49() {
  return <div className="absolute contents left-[190.08px] top-[8224.13px]"><Group50 /></div>;
}
function Group48() {
  return <div className="absolute contents left-[190.08px] top-[8224.13px]"><Group49 /></div>;
}
function Group47() {
  return <div className="absolute contents left-[190.08px] top-[8224.13px]"><Group48 /></div>;
}
export function Group46() {
  return <div className="absolute contents left-[190.08px] top-[8205.7px]"><Group47 /><div className="absolute flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[219.56px] justify-center leading-[0] left-[249.02px] not-italic text-[33.065px] text-center text-white top-[8205.7px] w-[547.008px]"><p className="leading-[1.5]">Intensive training (online)</p></div></div>;
}
function Body3() {
  return <div className="absolute bg-[rgba(255,255,255,0.5)] h-[181.008px] left-[1090.56px] rounded-[41.331px] top-[7683.98px] w-[644.352px]" data-name="Body"><div aria-hidden="true" className="absolute border-4 border-solid border-white inset-0 pointer-events-none rounded-[41.331px]" /></div>;
}
function Group57() {
  return <div className="absolute contents left-[1090.56px] top-[7683.98px]"><Body3 /></div>;
}
function Group56() {
  return <div className="absolute contents left-[1090.56px] top-[7683.98px]"><Group57 /></div>;
}
function Group55() {
  return <div className="absolute contents left-[1090.56px] top-[7683.98px]"><Group56 /></div>;
}
function Group54() {
  return <div className="absolute contents left-[1090.56px] top-[7683.98px]"><Group55 /></div>;
}
function Group53() {
  return <div className="absolute contents left-[1090.56px] top-[7683.98px]"><Group54 /></div>;
}
function Group52() {
  return <div className="absolute contents left-[779px] top-[8986.71px]"><div className="absolute flex flex-col font-['Inter:Extra_Bold',sans-serif] font-extrabold h-[442.424px] justify-center leading-[0] left-[779px] not-italic text-[44.087px] text-center text-white top-[8986.71px] w-[244.224px]"><p className="leading-[1.5] mb-0">​</p><p className="leading-[1.5]">​</p></div></div>;
}
function Group51() {
  return <div className="absolute contents left-[779px] top-[8986.71px]"><Group52 /></div>;
}

/* Line segments */
function Group67() {
  return <div className="absolute h-0 left-[880.87px] top-[8907px] w-[95.119px]"><div className="absolute inset-[-13.78px_0_0_0]"><svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 95.1194 13.7771"><g id="Group 1175"><line id="Line 3" stroke="var(--stroke-0, #46CF81)" strokeWidth="13.7771" x1="5.18846e-09" x2="95.1194" y1="6.88857" y2="6.88857" /></g></svg></div></div>;
}
function Group61() {
  return <div className="absolute h-0 left-[891.54px] top-[7792.5px] w-[85.899px]"><div className="absolute inset-[-6.89px_0]"><svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 85.8986 13.7771"><g id="Group 29"><path d={svgPaths.pc0db500} id="Line 2" stroke="var(--stroke-0, #51659C)" strokeWidth="13.7771" /></g></svg></div></div>;
}
function Group60() {
  return <div className="absolute contents left-[891.54px] top-[7792.5px]"><Group61 /></div>;
}
export function TimelineSection() {
  return <motion.section className="absolute contents left-[133.5px] top-[7341px]" initial={{
    opacity: 0,
    y: 50
  }} whileInView={{
    opacity: 1,
          ...
          <div className="absolute contents left-[133.5px] top-[7536px]">
            <div className="absolute contents left-[133.5px] top-[7536px]">
              ...
              <div className="absolute contents left-[133.5px] top-[7536px]">
                <Round1 />
                <div className="absolute contents left-[133.5px] top-[7536px]">
                  <div className="absolute flex h-[1606px] items-center justify-center left-[975.99px] top-[7536px] w-0" style={{
